...
Begin VB.Form frm_menuhistory 
   ...
   End
End
Attribute VB_Name = "frm_menuhistory"
...
With MDI_IMS.CrystalReport1
        .Reset
        .ReportFileName = FixDir(App.Path) + "CRreports\menuuserhistory.rpt"
        ...
        .ParameterFields(2) = "from;date(" & Year(DTfromdate.value) & "," & Month(DTfromdate.value) & "," & Day(DTfromdate.value) & ");true"
        .ParameterFields(3) = "to;date(" & Year(DTtodate.value) & "," & Month(DTtodate.value) & "," & Day(DTtodate.value) & ");true"
       
        'Modified by Juan (9/13/2000) for Multilingual
        msg1 = translator.Trans("M00196") 'J added
        .WindowTitle = IIf(msg1 = "", "Menu User History", msg1) 'J modified
        Call translator.Translate_Reports("menuuserhistory.rpt") 'J added
        '---------------------------------------------
...
Call translator.Translate_Forms("frm_menuhistory")
'------------------------------------------
'MsgBox "hola"
