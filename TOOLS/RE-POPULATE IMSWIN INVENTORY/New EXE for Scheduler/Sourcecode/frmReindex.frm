...
Call SendEmail("Successfully ran the reindex exe.", "Ims reindex ran Successfully.")
...
Call SendEmail("Errors Occurred while trying to re-populate the tables. Err Description : " & Err.Description, "Ims repopulate : Errors occurred")
