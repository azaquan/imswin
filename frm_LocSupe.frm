...
Begin VB.Form frm_LocSupe 
   ...
   Begin LRNavigators.NavBar NavBar1 
      ...
      ButtonWidth     =   345.26
      Style           =   1
      MouseIcon       =   "frm_LocSupe.frx":0000
      EMailVisible    =   -1  'True
      EditVisible     =   -1  'True
      EmailEnabled    =   -1  'True
      EditEnabled     =   -1  'True
   ...
   Begin TabDlg.SSTab sstSup 
      ...
      TabPicture(0)   =   "frm_LocSupe.frx":001C
      ...
      Tab(0).Control(11)=   "SSOleDBCombo1"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "SSDBLine"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "TxtRemarks"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "TxtSuppCode"
      ...
      TabPicture(1)   =   "frm_LocSupe.frx":0038
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "Recipients"
      TabPicture(2)   =   "frm_LocSupe.frx":0054
      ...
      TabPicture(3)   =   "frm_LocSupe.frx":0070
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "ssdbgContacts"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "Contract"
      TabPicture(4)   =   "frm_LocSupe.frx":008C
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "ssdbContract"
      Tab(4).Control(1)=   "MonthView1"
      Tab(4).Control(2)=   "MonthView2"
      ...
      Begin SSDataWidgets_B_OLEDB.SSOleDBGrid ssdbgContacts 
         ...
         BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(0).Picture=   "frm_LocSupe.frx":00A8
         ...
         BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(1).Picture=   "frm_LocSupe.frx":00C4
...
Private Sub SSOleDBCombo1_Click()
 deIms.rsLocSupplier.CancelUpdate
     deIms.rsLocSupplier.MoveFirst
If Not deIms.rsLocSupplier.State = 0 Then deIms.rsLocSupplier.Find "sup_code='" & (SSOleDBCombo1.Columns(0).value) & "'", adSearchForward
...
Private Sub SSOleDBCombo1_KeyPress(KeyAscii As Integer)
 If KeyAscii = 13 Then
    ...
    If Not FormMode = mdVisualization Then SSOleDBCombo1.MoveNext
...
Call imsLock.Unlock_Row(locked, deIms.cnIms, CurrentUser, rowguid, , dbtablename, , True) 'jawdat
 ...
 If FormMode = mdVisualization Then MakeReadOnly (False)
    ...
    'Added by Juan Gonzalez 2007-9-18
    ...
    Else '------------------------------
        ...
        ElseIf sstSup.Tab = 0 Then
           i = deIms.rsLocSupplier.EditMode
            rs.CancelUpdate
            deIms.rsLocSupplier.CancelUpdate
...
On Error GoTo ErrHandler
    ...
    With MDI_IMS.CrystalReport1
        ...
        .ParameterFields(2) = "IntLoc;" & "LOC" & ";TRUE"
...
sstSup.TabVisible(1) = False
   ...
   SSDBLine.IsItemInList
    ...
    Call deIms.LocSupplier(deIms.NameSpace)
    'Call deIms.LocsupplierLOOKUP(deIms.NameSpace)

'deIms.rsINtSupplier.CancelUpdate
     deIms.rsLocSupplier.CancelUpdate
    'SSOleDBCombo1.DataMemberList = "locsupplierLookUp"
    'Set SSOleDBCombo1.DataSourceList = deIms
    
    
    DoEvents
    Call BindAll(Me, deIms)
    Set rs = deIms.rsLocSupplier
...
'value becomes >0,due to which auto numbering is not activated.This statement forces it's Value to 0 in such a case
    ...
    If list <> 0 And deIms.rsLocSupplier.EditMode = adEditAdd And Len(TxtSuppCode) = 0 Then 'M
          list = 0  'M
     End If         'M
...
'commented out by JUAN 2008/1/28
'             FormMode = ChangeModeOfForm(lblStatus, mdCreation)
'             NavBar1.EditEnabled = True
...
'        Else
           ...
           If Len(Trim$(TxtSuppCode)) <> 0 Then
            ...
            End If   'M
                        ...
                        'deIms.rsLocSupplier!sup_name = Trim$(SSOleDBCombo1.text)
                            deIms.rsLocSupplier!sup_name = Trim$(txt_Name)
                        deIms.rsLocSupplier.Update
                       ...
                       'Added by juan 2007/9/14
                        ...
                        If FormMode = mdCreation Then
                            Sql = Sql + "sup_creauser='" + CurrentUser + "', "
                             deIms.rsLocSupplier!sup_creauser = CurrentUser
                        End If
                        Sql = Sql + "sup_modiuser='" + CurrentUser + "' "
                        Sql = Sql + "where sup_code='" + deIms.rsLocSupplier!sup_code + "'"
                        deIms.rsLocSupplier!sup_modiuser = CurrentUser 'JCG 2008/1/28
                        deIms.cnIms.Execute Sql + Err.Description
                         '---------------------------------------------
                       
                       'Both lines commented out by Muzammil 120/01/01
                       'deIms.rsLocSupplier!sup_modiuser = CurrentUser
                       ' Call deIms.rsLocSupplier.UpdateBatch(adAffectCurrent)

                        deIms.rsLocSupplier.Update 'JCG 2008/1/28
                        Call SaveContacts
                        Call deIms.rsLocSupplier.Move(0)
                       ...
                       ' deIms.rsLOCSUPPLIERLOOKUP.Close
                       ' Call deIms.LocsupplierLOOKUP(deIms.NameSpace)
                       ' Set SSOleDBCombo1.DataSourceList = deIms
                        ...
                        'deims.rsLocsupplierLOOKUP.Requery
         Else
             FormMode = ChangeModeOfForm(lblStatus, mdCreation)
             NavBar1.EditEnabled = True
             NavBar1.SaveEnabled = True
...
'        If dcboSuppCode = "" Then GetAutoNumber
...
'
'            MsgBox "Insert into Supplier was completed"
'        End If
...
'Private Sub optInternational_Click()
'    If deIms.rsIntSupplier!sup_flag = 0 Then _
'        deIms.rsIntSupplier!sup_flag = 1
'End Sub

'set back ground color

'Private Sub optInternational_GotFocus()
    'Call HighlightBackground(optInternational)
'End Sub

'set back ground color

'Private Sub optInternational_LostFocus()
   ' Call NormalBackground(optInternational)
'End Sub
...
'    If deIms.rsIntSupplier!sup_flag <> 0 Then _
'        deIms.rsIntSupplier!sup_flag = 0
'End Sub

'set back ground color

'Private Sub optLocal_GotFocus()
 '   Call HighlightBackground(optLocal)
'End Sub

'set back ground color

'Private Sub optLocal_LostFocus()
'    Call NormalBackground(optLocal)
'End Sub
...
Private Sub ssdbgContacts_InitColumnProps()
    ...
    'With ssdbgContacts.Columns(0) Commented out by JCG 2008/01/13
...
Dim iEditMode(1) As Integer
    ...
    Select Case sstSup.Tab
        ...
        Case 3
         ...
         End If
        Case 4 'Added by Juan Gonzalez 2007-9-18
            xx = 0
            If Not FormMode = mdModification Then
...
On Error Resume Next
    ...
    Do While Not rst.EOF
        'ssdbgContacts.AddItem ((rst!sct_contcode & "") & Chr(1) & (rst!sct_npecode & "") & Chr(1) & (rst!sct_supcode & "")) 'JCG 2008/01/13
...
Dim msg As String
    ...
    ElseIf Len(Trim$(txt_City)) = 0 Then
        ...
        MsgBox IIf(msg1 = "", "City MUST have a value.", msg1) 'J modified
        '----------------------------------------------
...
'SSOleDBCombo1.text = deIms.rsLocSupplier("sup_name").OriginalValue
txt_Address1 = IIf(IsNull(deIms.rsLocSupplier("sup_adr1").originalVALUE), "", deIms.rsLocSupplier("sup_adr1").originalVALUE)
txt_Email = IIf(IsNull(deIms.rsLocSupplier("sup_mail").originalVALUE), "", deIms.rsLocSupplier("sup_mail").originalVALUE)
txt_State = IIf(IsNull(deIms.rsLocSupplier("sup_stat").originalVALUE), "", deIms.rsLocSupplier("sup_stat").originalVALUE)
txt_Zipcode = IIf(IsNull(deIms.rsLocSupplier("sup_zipc").originalVALUE), "", deIms.rsLocSupplier("sup_zipc").originalVALUE)
txt_Address2 = IIf(IsNull(deIms.rsLocSupplier("sup_adr2").originalVALUE), "", deIms.rsLocSupplier("sup_adr2").originalVALUE)
txt_Country = IIf(IsNull(deIms.rsLocSupplier("sup_ctry").originalVALUE), "", deIms.rsLocSupplier("sup_ctry").originalVALUE)
txt_City = IIf(IsNull(deIms.rsLocSupplier("sup_city").originalVALUE), "", deIms.rsLocSupplier("sup_city").originalVALUE)
txt_FaxNumber = IIf(IsNull(deIms.rsLocSupplier("sup_faxnumb").originalVALUE), "", deIms.rsLocSupplier("sup_faxnumb").originalVALUE)
txt_PhoneNumber = IIf(IsNull(deIms.rsLocSupplier("sup_phonnumb").originalVALUE), "", deIms.rsLocSupplier("sup_phonnumb").originalVALUE)
Txt_contaname = IIf(IsNull(deIms.rsLocSupplier("sup_contaname").originalVALUE), "", deIms.rsLocSupplier("sup_contaname").originalVALUE)
Txt_contaPH = IIf(IsNull(deIms.rsLocSupplier("sup_contaph").originalVALUE), "", deIms.rsLocSupplier("sup_contaph").originalVALUE)
Txt_contaFax = IIf(IsNull(deIms.rsLocSupplier("sup_contafax").originalVALUE), "", deIms.rsLocSupplier("sup_contafax").originalVALUE)
TxtRemarks = IIf(IsNull(deIms.rsLocSupplier("sup_remk").originalVALUE), "", deIms.rsLocSupplier("sup_remk").originalVALUE)
End Function

Private Sub TxtSuppCode_LostFocus()
Call NormalBackground(TxtSuppCode)
End Sub
...
'''''If ConnInfo.EmailClient = Outlook Then
'''''
'''''    Call sendLocalOutlookEmailandFax
'''''
'''''ElseIf ConnInfo.EmailClient = ATT Then
'''''
'''''    Call SendLocalAttEmailandFax
'''''
...
'''''Private Sub SendLocalAttEmailandFax()
...
'''''Private Function sendLocalOutlookEmailandFax()
'''''Dim Params(1) As String
'''''Dim i As Integer
