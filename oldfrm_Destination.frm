...
Begin VB.Form oLDfrm_Destination 
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBGrid SSDBGDestination 
      Bindings        =   "oldfrm_Destination.frx":0000
      Height          =   3015
      Left            =   240
      TabIndex        =   1
      Top             =   600
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "oldfrm_Destination.frx":0014
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "oldfrm_Destination.frx":0030
      HeadFont3D      =   4
      DefColWidth     =   5292
   ...
   End
End
Attribute VB_Name = "oldfrm_Destination"
