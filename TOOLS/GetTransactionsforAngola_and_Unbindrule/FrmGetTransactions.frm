...
Begin VB.Form FrmTrasmission 
   ...
   Caption         =   "Get Transactions  V1.03"
   ClientHeight    =   1290
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8010
   ...
   Begin VB.Label Label3 
      BackColor       =   &H00808080&
      Caption         =   "Extracts a list of all the transactions and there line items for the namespace SAKHALIN."
      ForeColor       =   &H8000000E&
      Height          =   255
      Left            =   960
      TabIndex        =   2
...
subject = "All Transactions on machine " & Machinename & "."
...
attachments(0) = Trim(App.Path & "\TransactionDetails.txt")
messages = "Please check the attachment."
Call sendEmailOnly(messages, subject, emailAddresses, attachments)

If sa.FileExists(attachments(0)) Then sa.DeleteFile attachments(0), True
...
Sub sendEmailOnly(Message As String, subject As String, emailAddresses() As String, Attachment() As String)
    ...
    Call SendAttMail(Message, subject, emailAddresses, Attachment)
