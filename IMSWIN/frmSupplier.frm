...
Begin VB.Form frm_IntSupe 
   ...
   Begin TabDlg.SSTab sstSup 
      ...
      TabPicture(2)   =   "frmSupplier.frx":0038
      ...
      Begin SSDataWidgets_B_OLEDB.SSOleDBGrid ssdbgContacts 
         ...
         BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(0).Picture=   "frmSupplier.frx":0054
         ...
         BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         stylesets(1).Picture=   "frmSupplier.frx":0070
...
currentformname1 = Forms(3).Name
 ...
 Set imsLock = New imsLock.lock
  ...
  Call imsLock.Check_Lock(locked, deIms.cnIms, CurrentUser, GetValuesFromControls(ListOfPrimaryControls), currentformname1, rowguid)   'lock should be here, added by jawdat, 2.1.02
...
Private Sub NavBar1_OnCancelClick()
 ...
 Dim imsLock As imsLock.lock
 Set imsLock = New imsLock.lock
 Call imsLock.Unlock_Row(locked, deIms.cnIms, CurrentUser, rowguid)  'jawdat
...
If rsReceptList Is Nothing Then Exit Sub
    ...
    If ConnInfo.EmailClient = Outlook Then
        ...
        Call sendOutlookEmailandFax("Supplier.rpt", "Supplier", MDI_IMS.CrystalReport1, ParamsForCrystalReports, rsReceptList, Subject, attention)
    ...
    Select Case sstSup.Tab
        ...
        Case 3
          ...
          If Not FormMode = mdModification Then
            If ssdbgContacts.Columns(0).TagVariant <> TxtSuppCode Then
                NavBar1.DeleteVisible = False
...
On Error Resume Next
    ...
    With cmd
       ...
       .ActiveConnection = deIms.cnIms
        ...
        .CommandText = "Insert into SUPPLIERCONTACT(sct_npecode, sct_supcode, sct_contcode)"
        .CommandText = .CommandText & "VALUES(?,?,?)"

        cmd.Parameters.Refresh

        For Y = 0 To x
            Call .Execute(0, Array(np, SupCode, ssdbgContacts.Columns(0).value), adExecuteNoRecords)
            ssdbgContacts.MoveNext
        Next
