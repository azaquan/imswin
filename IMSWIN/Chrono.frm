...
End If
   ...
   End If
     If (response = vbOK) Or (response = vbYes) Then
        ssdbgKeys.Columns(1).text = RemoveNulls(ssdbgKeys.Columns(1).text)
        ssdbgKeys.Columns(2).text = RemoveNulls(ssdbgKeys.Columns(2).text)
        ssdbgKeys.Columns(4).text = RemoveNulls(ssdbgKeys.Columns(4).text)
        ssdbgKeys.Columns(5).text = RemoveNulls(ssdbgKeys.Columns(5).text)
        ssdbgKeys.Columns(6).text = RemoveNulls(ssdbgKeys.Columns(6).text)
