...
Object = "{27609682-380F-11D5-99AB-00D0B74311D4}#1.0#0"; "IMSMAI~2.OCX"
Begin VB.Form frmPackingList 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(31)=   "ShipperList"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "ShipToList"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "SoldToList"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "destinationList(4)"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "destinationList(2)"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "destinationList(3)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "destinationList(0)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "destinationList(1)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "PriorityList"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "PackingListList"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "txtClause"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "DTPicker1"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "cell(0)"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "cell(1)"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "cell(2)"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "cell(3)"
      Tab(0).Control(46).Enabled=   0   'False
      Tab(0).Control(47)=   "cell(4)"
      Tab(0).Control(47).Enabled=   0   'False
      Tab(0).Control(48)=   "cell(5)"
      Tab(0).Control(48).Enabled=   0   'False
      Tab(0).Control(49)=   "cell(6)"
      Tab(0).Control(49).Enabled=   0   'False
      Tab(0).Control(50)=   "cell(7)"
      Tab(0).Control(50).Enabled=   0   'False
      Tab(0).Control(51)=   "cell(8)"
      Tab(0).Control(51).Enabled=   0   'False
      Tab(0).Control(52)=   "cell(9)"
      Tab(0).Control(52).Enabled=   0   'False
      Tab(0).Control(53)=   "cell(10)"
      Tab(0).Control(53).Enabled=   0   'False
      Tab(0).Control(54)=   "cell(11)"
      Tab(0).Control(54).Enabled=   0   'False
      Tab(0).Control(55)=   "cell(12)"
      Tab(0).Control(55).Enabled=   0   'False
      Tab(0).Control(56)=   "cell(13)"
      Tab(0).Control(56).Enabled=   0   'False
      Tab(0).Control(57)=   "cell(14)"
      Tab(0).Control(57).Enabled=   0   'False
      Tab(0).Control(58)=   "cell(15)"
      Tab(0).Control(58).Enabled=   0   'False
      Tab(0).Control(59)=   "cell(16)"
      Tab(0).Control(59).Enabled=   0   'False
      Tab(0).Control(60)=   "cell(17)"
      Tab(0).Control(60).Enabled=   0   'False
      Tab(0).Control(61)=   "cell(18)"
      Tab(0).Control(61).Enabled=   0   'False
      Tab(0).Control(62)=   "cell(19)"
      Tab(0).Control(62).Enabled=   0   'False
      Tab(0).Control(63)=   "cell(20)"
      Tab(0).Control(63).Enabled=   0   'False
      Tab(0).Control(64)=   "cell(21)"
      Tab(0).Control(64).Enabled=   0   'False
      Tab(0).Control(65)=   "cell(22)"
      Tab(0).Control(65).Enabled=   0   'False
      Tab(0).Control(66)=   "cell(23)"
      Tab(0).Control(66).Enabled=   0   'False
      Tab(0).Control(67)=   "cell(24)"
      Tab(0).Control(67).Enabled=   0   'False
      Tab(0).Control(68)=   "cell(25)"
      Tab(0).Control(68).Enabled=   0   'False
      Tab(0).Control(69)=   "cell(26)"
      Tab(0).Control(69).Enabled=   0   'False
      Tab(0).Control(70)=   "cell(27)"
      Tab(0).Control(70).Enabled=   0   'False
      Tab(0).Control(71)=   "cell(28)"
      Tab(0).Control(71).Enabled=   0   'False
      Tab(0).Control(72)=   "cell(29)"
      Tab(0).Control(72).Enabled=   0   'False
      Tab(0).Control(73)=   "remarkBUTTON"
...
Dim dataPAKING As New ADODB.Recordset
    ...
    With dataPAKING
        ...
        End If
        For i = 0 To 4
            destinationList(i).RemoveItem (0)
...
Dim sql, text As String
    ...
    With dataPAKING
        If .RecordCount > 0 Then
            ...
            txtClause = IIf(IsNull(!txtClause), "", !txtClause)
...
Dim dataPAKING As New ADODB.Recordset
    ...
    With dataPAKING
        ...
        If .RecordCount > 0 Then
            ...
            Loop
        End If
        PackingListList.row = 0
    End With
End Sub

Sub getLINEitems(PackingList As String)
...
Dim i As Integer
    ...
    With dataPACKING
        If .RecordCount > 0 Then
            current = ""
            Do While Not .EOF
                If current <> !po And POlist.Rows > 2 Then
                    POlist.AddItem ""
                    current = !po
                End If
                rowTEXT = "" + vbTab
...
Dim dataPAKING As New ADODB.Recordset
    ...
    Set dataPAKING = New ADODB.Recordset
    sql = "SELECT pri_code, pri_desc FROM PRIORITY WHERE pri_npecode = '" + deIms.NameSpace + "' ORDER BY pri_desc"
    PriorityList.Rows = 0
    With dataPAKING
        .Open sql, deIms.cnIms, adOpenForwardOnly
        If Err.number <> 0 Then Exit Sub
...
Dim positionX, positionY, i As Integer
    With POlist
        If .TextMatrix(.row, 0) <> "" Then
            positionX = .Left + 20
            For i = 0 To .Col - 1
                positionX = positionX + .ColWidth(i) + 1
            Next
            positionY = .Top + 20
            For i = .topROW - 1 To .row - IIf(.topROW = 1, 1, 0)
                positionY = positionY + .RowHeight(i) + 1
            Next
            TextLINE.text = .text
    ...
    For i = 1 To POlist.Rows - 1
        If POlist.TextMatrix(i, 0) <> "" Then
            If IsNumeric(POlist.TextMatrix(i, 9)) Then
                If CDbl(POlist.TextMatrix(i, 9)) > 0 Then
                    If POlist.TextMatrix(i, 8) < POlist.TextMatrix(i, 9) Then
                        wrong = True
                        position = i
                        readyFORsave = False
                        Exit For
...
If rsReceptList Is Nothing Then Exit Sub
    ...
    If ConnInfo.EmailClient = Outlook Then
        ...
        Call sendOutlookEmailandFax("packinglist.rpt", "Packing List", MDI_IMS.CrystalReport1, ParamsForCrystalReports, rsReceptList, subject, Attention)
...
On Error Resume Next
    ...
    If readyFORsave Then
        ...
        sql = "SELECT * FROM PACKINGLIST WHERE pl_manfnumb = ''"
        ...
        With header
            ...
            !pl_viacarr = cell(5)
            !pl_shipterm = cell(6)
            !pl_dest = destinationList(0).TextMatrix(destinationList(4).row, 1)
            !pl_etd = CDate(cell(8))
            !pl_eta = CDate(cell(9))
            !pl_fig1 = cell(10)
            !pl_from1 = destinationList(1).TextMatrix(destinationList(0).row, 1)
            !pl_to1 = destinationList(2).TextMatrix(destinationList(1).row, 1)
            If cell(13) <> "" Then
                !pl_fig2 = cell(13)
                !pl_from2 = destinationList(3).TextMatrix(destinationList(1).row, 1)
                !pl_to2 = destinationList(4).TextMatrix(destinationList(2).row, 1)
            End If
        ...
        sql = "SELECT * FROM PACKINGREC WHERE plrc_manfnumb = ''"
        ...
        sql = "SELECT * FROM PACKINGDETL WHERE pld_ponum = ''"
        details.Open sql, deIms.cnIms, adOpenKeyset, adLockPessimistic
        With details
            lineN = 1
            For i = 1 To POlist.Rows - 1
                If POlist.TextMatrix(i, 0) <> "" Then
                    ...
                    If PoItem.RecordCount > 0 Then
                        ...
                        If POread.RecordCount > 0 Then
                            ...
                            POdata.Open sql, deIms.cnIms, adOpenDynamic, adLockPessimistic
...
Private Sub POlist_RowColChange()
        ...
        If Form <> mdVisualization Then
            If IsNumeric(.Tag) Then
                If val(.Tag) <> .row Then
                    currentROW = .row
                    .row = val(.Tag)
                    If .CellBackColor <> txtClause.BackColor Then
                        Call Coloring(txtClause.BackColor)
                    End If
                    .row = currentROW
                End If
            End If
