...
str = " update  invtreceipt set ir_tbs=1 where ir_trannumb in ('RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"
str = str & " update  invtreceiptdetl set ird_tbs=1 where ird_trannumb in ('RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"
str = str & " update  invtreceiptrem set irr_tbs=1 where irr_trannumb in ('152','RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"

str = str & " update  invtissue set ii_tbs=1 where ii_trannumb in ('RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"
str = str & " update  invtissuedetl set iid_tbs=1 where iid_trannumb in ('RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"
str = str & " update  invtissuerem set iir_tbs=1 where iir_trannumb in ('RT-20551','I-20552','AI-20553','AI-20554','AE-20555')"
