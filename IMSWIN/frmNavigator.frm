VERSION 5.00
Object = "{27609697-380F-11D5-99AB-00D0B74311D4}#1.0#0"; "LRLABE~1.OCX"
...
Private Sub lblSubAccounting_Click(Index As Integer)
    Select Case Index
 Case 0
 ...
 Case 1
    Load frmWareHouseIssue
    frmWareHouseIssue.Top = 0
    frmWareHouseIssue.Left = 0
    frmWareHouseIssue.Visible = True
    frmWareHouseIssue.ZOrder 0
 
 Case 2
    Load frmWHAdjustment
    frmWHAdjustment.Move 0, 0
    frmWHAdjustment.Visible = True
    frmWHAdjustment.ZOrder 0
...
Private Sub lblSubWharehousing_Click(Index As Integer)
On Error Resume Next
...
Case 0
    ...
    frmWarehouse.Top = 0
    frmWarehouse.Left = 0
    frmWarehouse.Visible = True
'    frmWarehouse.Caption = "Receipt of goods"
Case 2
    Load frmIssue
    frmIssue.Show
'    frmIssue.Caption = "Issue"
Case 3
    Load frmReturnFromWell
    Call frmReturnFromWell.Move(0, 0)
    frmReturnFromWell.Visible = True
'    frmReturnFromWell.Caption = "Return from Wellsite"
Case 4
    Load frmReturnFromRepair
    Call frmReturnFromRepair.Move(0, 0)
    frmReturnFromRepair.Visible = True
'    frmReturnFromRepair.Caption = "Return from Repair"
Case 5
    Load frmWellToWell
    frmWellToWell.ZOrder 0
    Call frmWellToWell.Move(0, 0)
'    frmWellToWell.Caption = "Well to Well"
    frmWellToWell.Show
Case 6
    Load frmBaseToBase
    Call frmBaseToBase.Move(0, 0)
    frmBaseToBase.Visible = True
'    frmBaseToBase.Caption = "Base to Base"
Case 7
    Load frmIntTransfer
    Call frmIntTransfer.Move(0, 0)
    frmIntTransfer.Visible = True
'    frmIntTransfer.Caption = "Internal Transfer"
 End Select
