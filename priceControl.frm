...
Begin VB.Form priceControlReport 
   ...
   Begin LRNavigators.NavBar NavBar1 
      ...
      ButtonWidth     =   345.26
      MouseIcon       =   "priceControl.frx":0000
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBCombo ssdcbolocation 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "priceControl.frx":001C
      ...
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "priceControl.frx":0038
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBCombo SSOleDBCompa 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "priceControl.frx":0054
      stylesets(0).AlignmentText=   0
      stylesets(1).Name=   "ColHeader"
      stylesets(1).HasFont=   -1  'True
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "priceControl.frx":0070
      stylesets(1).AlignmentText=   1
      HeadFont3D      =   4
      DefColWidth     =   5292
      ForeColorEven   =   8388608
   ...
   Begin SSDataWidgets_B_OLEDB.SSOleDBCombo SSOleDBCurrency 
      ...
      BeginProperty stylesets(0).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(0).Picture=   "priceControl.frx":008C
      stylesets(0).AlignmentText=   0
      stylesets(1).Name=   "ColHeader"
      stylesets(1).HasFont=   -1  'True
      BeginProperty stylesets(1).Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      stylesets(1).Picture=   "priceControl.frx":00A8
      stylesets(1).AlignmentText=   1
      HeadFont3D      =   4
      DefColWidth     =   5292
      ForeColorEven   =   8388608
   ...
   End
End
Attribute VB_Name = "priceControlReport"
...
Private Sub NavBar1_OnEMailClick()
    ...
    invocation = "cd \imsReportGenerator & java -jar reportGenerator.jar -name priceControlReport -xuser " + Chr(34) + CurrentUser + Chr(34) + " "
