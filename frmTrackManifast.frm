...
Dim ParamsForCrystalReports() As String
    ...
    ReDim ParamsForCrystalReports(2)
        ...
        ParamsForCrystalReports(1) = "mesgnumb;" + SScmbMessage.Text + ";TRUE"
        ParamsForCrystalReports(2) = "ponumb;" + cmbPOnumber + ";true"

    
    Call sendOutlookEmailandFax(Report_EmailFax_TrackingPo, "Tracking Message Header", MDI_IMS.CrystalReport1, ParamsForCrystalReports, rsr, Me.Caption, "")
...
'    Call WriteRPTIFile(rptinfo, FileName(0))
    ...
    If chkYesorNo.value = 1 Then
        ...
        SetPOReportParam
         ...
         ParamsForCrystalReports(0) = "namespace;" + deIms.NameSpace + ";TRUE"
          ParamsForCrystalReports(1) = "manifestnumb;" + cmbPOnumber + ";true"
            
          Call sendOutlookEmailandFax(Report_EmailFax_PackingManifest_name, "Packing List", MDI_IMS.CrystalReport1, ParamsForCrystalReports, rsr, Me.Caption, "")
