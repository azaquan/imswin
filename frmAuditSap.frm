...
On Error GoTo ErrHandler
    ...
    With MDI_IMS.CrystalReport1
        .Reset
        .ReportFileName = FixDir(App.Path) + "CRreports\sapanalysis.rpt"
...
'        .ParameterFields(3) = "curr;" + IIf(Trim$(SSOleDBCurrency.Columns("code").Text) = "ALL", "ALL", SSOleDBCurrency.Columns("code").Text) + ";TRUE"
        ...
        Call translator.Translate_Reports("sapanalysis.rpt") 'J added
        '---------------------------------------------
...
RSstkMaster.Source = "select sap_stcknumb from sap where sap_compcode='" & Trim$(SSOleDBCompany) & "' and sap_loca='" & Trim$(SSOleDBLocation) & "'  and sap_npecode='" & deIms.NameSpace & "'"
