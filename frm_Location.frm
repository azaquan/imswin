...
Begin VB.Form frm_Location 
   ...
   Begin LRNavigators.NavBar NavBar1 
      ...
      ButtonWidth     =   345.26
      MouseIcon       =   "frm_Location.frx":0000
      EmailEnabled    =   -1  'True
      EditEnabled     =   -1  'True
...
On Error Resume Next
    ...
    If cboComp.ListIndex <> CB_ERR Then
        Call PopuLateFromRecordSet(cboCode, _
            loc.LocationCodes(deIms.NameSpace, cboComp, deIms.cnIms), "Code", True)
